...
from Packages.data.convert import get_framework, GetNPArrayFromSITK, GetSITKImageFromNP
...
def image_interp_3d(x, y, z, image):
  if ((math.floor(x) < 0) or (math.ceil(x) >= image.shape[0])
      or (math.floor(y) < 0) or (math.ceil(y) >= image.shape[1])
      or (math.floor(z) < 0) or (math.ceil(z) >= image.shape[2])):
     # data is out of bounds, return identity vector
     scalar = 1
     return scalar

  if x == math.floor(x) and y == math.floor(y) and z == math.floor(z):
    scalar = image[int(x), int(y), int(z)]
  elif x == math.floor(x) and y != math.floor(y) and z != math.floor(z):
    scalar = abs(y - math.floor(y)) * abs(z - math.floor(z)) * image[int(x), math.ceil(y), math.ceil(z)] \
                 + abs(y - math.ceil(y)) * abs(z - math.floor(z)) * image[int(x), math.floor(y), math.ceil(z)] \
                 + abs(y - math.floor(y)) * abs(z - math.ceil(z)) * image[int(x), math.ceil(y), math.floor(z)] \
                 + abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * image[int(x), math.floor(y), math.floor(z)] 
  elif x == math.floor(x) and y == math.floor(y) and z != math.floor(z):
    scalar = abs(z - math.floor(z)) * image[int(x), int(y), math.ceil(z)] \
                 + abs(z - math.ceil(z)) * image[int(x), int(y), math.floor(z)] 
  elif x != math.floor(x) and y == math.floor(y) and z != math.floor(z):
    scalar = abs(x - math.floor(x)) * abs(z - math.floor(z)) * image[math.ceil(x), int(y), math.ceil(z)] \
                 + abs(x - math.ceil(x)) * abs(z - math.floor(z)) * image[math.floor(x), int(y), math.ceil(z)] \
                 + abs(x - math.floor(x)) * abs(z - math.ceil(z)) * image[math.ceil(x), int(y), math.floor(z)] \
                 + abs(x - math.ceil(x)) * abs(z - math.ceil(z)) * image[math.floor(x), int(y), math.floor(z)]
  elif x != math.floor(x) and y == math.floor(y) and z == math.floor(z):
    scalar = abs(x - math.floor(x)) * image[math.ceil(x), int(y),int(z)] \
                 + abs(x - math.ceil(x)) * image[math.floor(x), int(y), int(z)]
  elif x != math.floor(x) and y != math.floor(y) and z == math.floor(z):
    scalar = abs(x - math.floor(x)) * abs(y - math.floor(y)) * image[math.ceil(x), math.ceil(y), int(z)] \
                 + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * image[math.floor(x), math.ceil(y), int(z)] \
                 + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * image[math.ceil(x), math.floor(y), int(z)] \
                 + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * image[math.floor(x), math.floor(y), int(z)]  
  elif x == math.floor(x) and y != math.floor(y) and z == math.floor(z):
    scalar = abs(y - math.floor(y)) * image[int(x), math.ceil(y), int(z)] \
                 + abs(y - math.ceil(y)) * image[int(x), math.floor(y), int(z)]
  else:
    scalar = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * image[math.ceil(x), math.ceil(y), math.ceil(z)] \
           + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * image[math.ceil(x), math.floor(y), math.ceil(z)] \
           + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * image[math.floor(x), math.ceil(y), math.ceil(z)] \
           + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * image[math.floor(x), math.floor(y), math.ceil(z)] \
           + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * image[math.ceil(x), math.ceil(y), math.floor(z)] \
           + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * image[math.ceil(x), math.floor(y), math.floor(z)] \
           + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * image[math.floor(x), math.ceil(y), math.floor(z)] \
           + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * image[math.floor(x), math.floor(y), math.floor(z)]
...
def vect_distrib_3d(x, y, z, vect, vector_field):
  if x == math.floor(x) and y == math.floor(y) and z == math.floor(z):
    vector_field[:, int(x), int(y), int(z)] += vect
  elif x == math.floor(x) and y != math.floor(y) and z != math.floor(z):
    vector_field[:, int(x), math.ceil(y), math.ceil(z)] += abs(y - math.floor(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, int(x), math.floor(y), math.ceil(z)] += abs(y - math.ceil(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, int(x), math.ceil(y), math.floor(z)] += abs(y - math.floor(y)) * abs(z - math.ceil(z)) * vect 
    vector_field[:, int(x), math.floor(y), math.floor(z)] += abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * vect 
  elif x == math.floor(x) and y == math.floor(y) and z != math.floor(z):
    vector_field[:, int(x), int(y), math.ceil(z)] += abs(z - math.floor(z)) * vect 
    vector_field[:, int(x), int(y), math.floor(z)] += abs(z - math.ceil(z)) * vect
  elif x != math.floor(x) and y == math.floor(y) and z != math.floor(z):
    vector_field[:, math.ceil(x), int(y), math.ceil(z)] += abs(x - math.floor(x)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.floor(x), int(y), math.ceil(z)] += abs(x - math.ceil(x)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.ceil(x), int(y), math.floor(z)] += abs(x - math.floor(x)) * abs(z - math.ceil(z)) * vect 
    vector_field[:, math.floor(x), int(y), math.floor(z)] += abs(x - math.ceil(x)) * abs(z - math.ceil(z)) * vect
  elif x != math.floor(x) and y == math.floor(y) and z == math.floor(z):
    vector_field[:, math.ceil(x), int(y),int(z)] += abs(x - math.floor(x)) * vect 
    vector_field[:, math.floor(x), int(y), int(z)] += abs(x - math.ceil(x)) * vect
  elif x != math.floor(x) and y != math.floor(y) and z == math.floor(z):
    vector_field[:, math.ceil(x), math.ceil(y), int(z)] += abs(x - math.floor(x)) * abs(y - math.floor(y)) * vect 
    vector_field[:, math.floor(x), math.ceil(y), int(z)] += abs(x - math.ceil(x)) * abs(y - math.floor(y)) * vect 
    vector_field[:, math.ceil(x), math.floor(y), int(z)] += abs(x - math.floor(x)) * abs(y - math.ceil(y)) * vect 
    vector_field[:, math.floor(x), math.floor(y), int(z)] += abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * vect 
  elif x == math.floor(x) and y != math.floor(y) and z == math.floor(z):
    vector_field[:, int(x), math.ceil(y), int(z)] += abs(y - math.floor(y)) * vect 
    vector_field[:, int(x), math.floor(y), int(z)] += abs(y - math.ceil(y)) * vect
  else:
    vector_field[:, math.ceil(x), math.ceil(y), math.ceil(z)] += abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.ceil(x), math.floor(y), math.ceil(z)] += abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.floor(x), math.ceil(y), math.ceil(z)] += abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.floor(x), math.floor(y), math.ceil(z)] += abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * vect 
    vector_field[:, math.ceil(x), math.ceil(y), math.floor(z)] += abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * vect 
    vector_field[:, math.ceil(x), math.floor(y), math.floor(z)] += abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * vect 
    vector_field[:, math.floor(x), math.ceil(y), math.floor(z)] += abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * vect 
    vector_field[:, math.floor(x), math.floor(y), math.floor(z)] += abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * vect
  return (vector_field)

@njit()
def batch_vect_interp_3d(x, y, z, vector_field):
  v1 = vector_field[0]
  v2 = vector_field[1]
  v3 = vector_field[2]
  num_tens = x.shape[0]
  vect = np.zeros((num_tens,3))

  x = np.where(x<0,0,x)
  x = np.where(x>=v1.shape[0]-1,v1.shape[0]-1,x)
  y = np.where(y<0,0,y)
  y = np.where(y>=v1.shape[1]-1,v1.shape[1]-1,y)
  z = np.where(z<0,0,z)
  z = np.where(z>=v1.shape[2]-1,v1.shape[2]-1,z)
  ...
  for p in range(num_tens):
    if x[p] == math.floor(x[p]) and y[p] == math.floor(y[p]) and z[p] == math.floor(z[p]):
      vect[p,0] = v1[int(x[p]), int(y[p]), int(z[p])]
      vect[p,1] = v2[int(x[p]), int(y[p]), int(z[p])]
      vect[p,2] = v3[int(x[p]), int(y[p]), int(z[p])]
    elif x[p] == math.floor(x[p]) and y[p] != math.floor(y[p]) and z[p] != math.floor(z[p]):
      vect[p,0] = abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v1[int(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v1[int(x[p]), math.floor(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[int(x[p]), math.ceil(y[p]), math.floor(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[int(x[p]), math.floor(y[p]), math.floor(z[p])] 
      vect[p,1] = abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v2[int(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v2[int(x[p]), math.floor(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[int(x[p]), math.ceil(y[p]), math.floor(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[int(x[p]), math.floor(y[p]), math.floor(z[p])] 
      vect[p,2] = abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v3[int(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v3[int(x[p]), math.floor(y[p]), math.ceil(z[p])] \
                 + abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[int(x[p]), math.ceil(y[p]), math.floor(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[int(x[p]), math.floor(y[p]), math.floor(z[p])] 
    elif x[p] == math.floor(x[p]) and y[p] == math.floor(y[p]) and z[p] != math.floor(z[p]):
      vect[p,0] = abs(z[p] - math.floor(z[p])) * v1[int(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(z[p] - math.ceil(z[p])) * v1[int(x[p]), int(y[p]), math.floor(z[p])] 
      vect[p,1] = abs(z[p] - math.floor(z[p])) * v2[int(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(z[p] - math.ceil(z[p])) * v2[int(x[p]), int(y[p]), math.floor(z[p])] 
      vect[p,2] = abs(z[p] - math.floor(z[p])) * v3[int(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(z[p] - math.ceil(z[p])) * v3[int(x[p]), int(y[p]), math.floor(z[p])] 
    elif x[p] != math.floor(x[p]) and y[p] == math.floor(y[p]) and z[p] != math.floor(z[p]):
      vect[p,0] = abs(x[p] - math.floor(x[p])) * abs(z[p] - math.floor(z[p])) * v1[math.ceil(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.floor(z[p])) * v1[math.floor(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.ceil(x[p]), int(y[p]), math.floor(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.floor(x[p]), int(y[p]), math.floor(z[p])]
      vect[p,1] = abs(x[p] - math.floor(x[p])) * abs(z[p] - math.floor(z[p])) * v2[math.ceil(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.floor(z[p])) * v2[math.floor(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.ceil(x[p]), int(y[p]), math.floor(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.floor(x[p]), int(y[p]), math.floor(z[p])]
      vect[p,2] = abs(x[p] - math.floor(x[p])) * abs(z[p] - math.floor(z[p])) * v3[math.ceil(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.floor(z[p])) * v3[math.floor(x[p]), int(y[p]), math.ceil(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.ceil(x[p]), int(y[p]), math.floor(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.floor(x[p]), int(y[p]), math.floor(z[p])]
    elif x[p] != math.floor(x[p]) and y[p] == math.floor(y[p]) and z[p] == math.floor(z[p]):
      vect[p,0] = abs(x[p] - math.floor(x[p])) * v1[math.ceil(x[p]), int(y[p]),int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * v1[math.floor(x[p]), int(y[p]), int(z[p])]
      vect[p,1] = abs(x[p] - math.floor(x[p])) * v2[math.ceil(x[p]), int(y[p]),int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * v2[math.floor(x[p]), int(y[p]), int(z[p])]
      vect[p,2] = abs(x[p] - math.floor(x[p])) * v3[math.ceil(x[p]), int(y[p]),int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * v3[math.floor(x[p]), int(y[p]), int(z[p])]
    elif x[p] != math.floor(x[p]) and y[p] != math.floor(y[p]) and z[p] == math.floor(z[p]):
      vect[p,0] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * v1[math.ceil(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * v1[math.floor(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * v1[math.ceil(x[p]), math.floor(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * v1[math.floor(x[p]), math.floor(y[p]), int(z[p])]  
      vect[p,1] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * v2[math.ceil(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * v2[math.floor(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * v2[math.ceil(x[p]), math.floor(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * v2[math.floor(x[p]), math.floor(y[p]), int(z[p])]  
      vect[p,2] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * v3[math.ceil(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * v3[math.floor(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * v3[math.ceil(x[p]), math.floor(y[p]), int(z[p])] \
                 + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * v3[math.floor(x[p]), math.floor(y[p]), int(z[p])]  
    elif x[p] == math.floor(x[p]) and y[p] != math.floor(y[p]) and z[p] == math.floor(z[p]):
      vect[p,0] = abs(y[p] - math.floor(y[p])) * v1[int(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * v1[int(x[p]), math.floor(y[p]), int(z[p])]
      vect[p,1] = abs(y[p] - math.floor(y[p])) * v2[int(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * v2[int(x[p]), math.floor(y[p]), int(z[p])]
      vect[p,2] = abs(y[p] - math.floor(y[p])) * v3[int(x[p]), math.ceil(y[p]), int(z[p])] \
                 + abs(y[p] - math.ceil(y[p])) * v3[int(x[p]), math.floor(y[p]), int(z[p])]
    else:
      vect[p,0] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v1[math.ceil(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v1[math.ceil(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v1[math.floor(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v1[math.floor(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.ceil(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.ceil(x[p]), math.floor(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.floor(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v1[math.floor(x[p]), math.floor(y[p]), math.floor(z[p])]
      vect[p,1] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v2[math.ceil(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v2[math.ceil(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v2[math.floor(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v2[math.floor(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.ceil(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.ceil(x[p]), math.floor(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.floor(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v2[math.floor(x[p]), math.floor(y[p]), math.floor(z[p])]
      vect[p,2] = abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v3[math.ceil(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v3[math.ceil(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.floor(z[p])) * v3[math.floor(x[p]), math.ceil(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.floor(z[p])) * v3[math.floor(x[p]), math.floor(y[p]), math.ceil(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.ceil(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.floor(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.ceil(x[p]), math.floor(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.floor(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.floor(x[p]), math.ceil(y[p]), math.floor(z[p])] \
           + abs(x[p] - math.ceil(x[p])) * abs(y[p] - math.ceil(y[p])) * abs(z[p] - math.ceil(z[p])) * v3[math.floor(x[p]), math.floor(y[p]), math.floor(z[p])]
  return (vect)
...
def tens_interp_3d(x, y, z, tensor_field):
  ...
  eps13 = tensor_field[...,0,2]
  eps22 = tensor_field[...,1,1]
  eps23 = tensor_field[...,1,2]
  eps33 = tensor_field[...,2,2]
